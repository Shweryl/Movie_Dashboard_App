<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage='Genres' subPage='Edit Genre'
                            ...
                            <div class="">
                                <form action="{{ route('genres.update', $genre->id) }}" method="post">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" value="{{old('name', $genre->name)}}" class="form-control border-1 border-primary" name="name" id="">
                                        @error('name')
                                            <div class="text-danger inputerror">{{$message}}</div>
                                        @enderror
                                    </div>
                                    <div class="">
                                        <button class="btn btn-primary">Edit Genre</button>
                                    </div>
                                </form>
                            </div>
                        </div>
